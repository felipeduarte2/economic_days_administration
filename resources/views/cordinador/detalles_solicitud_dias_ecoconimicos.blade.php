            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <form method="POST" action="{{ route('cordinador.detalles_solicitud_d.accept', $solicitud) }}">
                            @csrf
                            @method('put')
                        ...
                        <form method="POST" action="{{ route('cordinador.detalles_solicitud_d.reject', $solicitud) }}">
                            @csrf
                            @method('put')
